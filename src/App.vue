...
watch(todos, (newVal) => {
  ...
  if (Array.isArray(newVal)) {
    localStorage.setItem('todos', JSON.stringify(newVal.sort((a, b) => a.createdAt - b.createdAt)));
  }
}, {
  deep: true
});
...
<template>
	<main class="app">
		...
		<section class="greeting">
			<h2 class="title">
				Hello there, <input type="text" id="name" placeholder="Name here" v-model="name">!
			</h2>
		</section>
				...
				<div class="options">
					...
					<label>
						<input 
							...
							value="not-important"
							v-model="input_category" />
						<span class="bubble not-important"></span>
